...
def load_sensor_positions(mat_path: str) -> np.ndarray:
    ...
    Returns pos2d: [64, 2] array (x, y columns from the 3D pos).
    """
    mat = scipy.io.loadmat(mat_path)
    pos3d = mat['pos']  # [64, 3]
    return pos3d[:, :2].astype(float)  # use x, y as 2D projection
...
def visualize_outputs(visual_dir: Path,
    ...
    try:
        ...
        topo_values = topo_values ** 0.35  # gamma correction to highlight highs
